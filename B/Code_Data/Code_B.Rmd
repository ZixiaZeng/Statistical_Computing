...
\[
-\left(u^2 e^{-\lambda u} \Big|_0^{\infty}\right) - \int_0^{\infty} e^{-\lambda u} \, du^2
\]
...
1. **Evaluating** \( u^2 e^{-\lambda u} \Big|_0^{\infty} \):
   ...
   \[
   \lim_{u \to \infty} u^2 e^{-\lambda u} - \lim_{u \to 0} u^2 e^{-\lambda u}
   \]

   As \( u \to \infty \), \( u^2 e^{-\lambda u} \to 0 \) (since \( e^{-\lambda u} \) decays to zero faster than \( u^2 \) grows). At \( u = 0 \), \( u^2 e^{-\lambda u} = 0 \).
